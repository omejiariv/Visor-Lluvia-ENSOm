...
# --- Configuración de la página y UI ---
st.set_page_config(layout="wide", page_title="Visor de Precipitación y Fenómeno ENSO")
...
tab1, tab2, tab_anim, tab3, tab_stats, tab4, tab_enso_sum, tab5 = st.tabs(["Gráficos", "Mapa de Estaciones", "Mapas Avanzados", "Tabla de Estaciones", "Estadísticas", "Anomalías y Tendencias", "Resumen por ENSO", "Descargas"])
